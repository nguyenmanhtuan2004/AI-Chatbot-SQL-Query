...
12. **LineID (Mã chuyền):** Cột `LineID` là kiểu VARCHAR, có dạng `'LINE_01'`, `'LINE_02'`,... KHÔNG ĐƯỢC dùng số nguyên (vd: `LineID = 1`). Khi người dùng nói "chuyền 1", "chuyền 2",... phải dịch sang `LineID = 'LINE_01'`, `LineID = 'LINE_02'`,...
# OUTPUT FORMAT
